$(function () {
    $("#jqGrid").jqGrid({
        ...
        datatype: "json",
        colModel: [
            {label: 'id', name: 'blogId', index: 'blogId', width: 50, formatter: idFormatter,key: true},
    ...
    function idFormatter(cellvalue) {
        return "<button onClick='editBlogRow("+cellvalue+")' type=\"button\" class=\"btn btn-block btn-secondary btn-sm\" style=\"width: 50%;\">"+cellvalue+"</button>";
